...
//TODO in fast rendering mode, the normals dont seem to work... maybe we need to rotate them by the inverse
...
window.onload = function(){
	...
	var sandpile = new Sandpile3D(19,19,14,96);
	...
	var loopCtl = setInterval(function(){
		...
		if(sandpile.update()){
			...
			//TODO if you add rotation, get the inverse of model matrix for the vert shader
			//cam.roll(1);
			//cam.slide(10,0,0);
